...
def MeanSquarredErrorL2(**kwargs):
    labels , targets, parameters, regularizing_constant, batch_size = kwargs['labels'] , kwargs['targets'] , kwargs['parameters'], kwargs['regularizing_constant'], kwargs['batch_size']
